...
from transformers import BertTokenizer, BertTokenizerFast,RobertaTokenizer, RobertaTokenizerFast,\
    XLMRobertaTokenizer, XLMRobertaTokenizerFast,HerbertTokenizer, HerbertTokenizerFast,XLMTokenizer
...
class DataCollatorForWholeWordMask(DataCollatorForLanguageModeling):
    ...
    def __call__(
        ...
        for e in examples:
            ...
            mask_labels.append(self._whole_word_mask(ref_tokens, max_predictions=self.tokenizer.model_max_length))
    ...
    def _whole_word_mask(self, input_tokens: List[str], max_predictions=512):
        ...
        is_herbert_tokenizer = isinstance(self.tokenizer, (HerbertTokenizer, HerbertTokenizerFast))
